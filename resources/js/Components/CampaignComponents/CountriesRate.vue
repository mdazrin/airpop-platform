...
function removeList(listIndex){
  ...
  const selectedListIndex = ref(-1); // Initialize with an invalid index
  
  const showFilteredRows = (listIndex) => {
        ...
        >
            ...
            class="flex flex-col w-2/3 sm:w-4/5">
                ...
                class="flex items-center">
                    ...
                    <li class="w-full" @click="showFilteredRows(listIndex)">
                        <input
                        v-model="searchQuery"
                        type="text"
                ...
                <div class="absolute right-0 w-full bg-white border rounded-lg shadow-lg z-20" v-if="selectedListIndex == listIndex">
            ...
            <div class="flex flex-col w-1/3 sm:w-1/5">
                ...
                <input type="number" class="border-0 border rounded-lg focus:border-transparent focus:ring-0" id="rate">
            </div>
